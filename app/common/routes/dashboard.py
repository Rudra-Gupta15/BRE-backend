"""/dashboard routes — KPI tiles, charts and recent-statement rows for the
Overview page, read from the persistence layer / session log.
"""

from fastapi import APIRouter

from app.common.persistence import dashboard_snapshot
