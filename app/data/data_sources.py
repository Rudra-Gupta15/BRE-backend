# Mirrors the frontend's original src/data/dataSources.js — the 11
# canonical financial data vectors plus quick-start preset selections used
...
PRESET_CONFIGS = [
    ...
    },
    {
        ...
        "selectedIds": [
            "account_aggregator", "gst_data", "bbps_utility", "upi_enrichment", "telecom_score",
            "cersai_search", "land_registry", "satellite_avm", "ecommerce_data", "image_forensics", "psychometric_score",
        ],
    },
]
